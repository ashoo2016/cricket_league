...
{
    public $token = '0461b86e0a58765cd651c9068e0ccd73';
    ...
    {
       $api_url  =  "https://rest.entitysport.com/v2/matches/?status=1&token=".$this->token."&per_page=20";
        $ch = curl_init();
        ...
        foreach($cricketMatches as $matchs) { 
            ...
            foreach ($items as $item) {
              //  echo "<pre>"; print_r($item);die;
                ...
                $afterdate = date( "Y-m-d H:i:s", strtotime( "+4 days"));
                if($afterdate >= $time1)
                {
